...
; Join a string into one long string of characters without spaces
; Takes *text in eax as input
; TODO: This can be improved. Instead of looping through and shifting the entire string after a space, we can stop shifting at the next space, mov eax to that location, and re-run the shift from there.
stripSpaces:
	push	ebx
	push	ecx
	push	edx
